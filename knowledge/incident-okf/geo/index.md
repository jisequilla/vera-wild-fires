# geo — la capa espacial

Marcadores geocodificados, rutas, fases aproximadas del fuego y configuración de capas satelitales. Coordenadas solo de Nominatim; lo aproximado, siempre marcado.

<!-- okf:index:begin -->
- **[Capa Copernicus EMS · EMSR892 (DEL v1)](capa-copernicus-emsr892.md)** — Cartografía oficial de emergencia de Copernicus para este incendio; área quemada y frentes de fuego observados.
- **[Capa NASA FIRMS · focos de calor 24 h](capa-firms-focos-calor.md)** — Focos de calor de las últimas 24 horas (VIIRS/MODIS) de NASA FIRMS sobre la zona del incendio.
- **[Fase 1 · Inicio del fuego](fase-1-inicio.md)** — Un cable eléctrico caído en el km 511 de la N-340A prende el espartal seco cerca de Los Gallardos.
- **[Fase 2 · Nivel de emergencia 2](fase-2-nivel-emergencia-2.md)** — El fuego sube por los barrancos hacia Bédar con rachas de hasta 70 km/h; INFOCA moviliza 150 efectivos.
...
- **[Cabezo María (Antas) · evacuado, retorno pendiente](marker-cabezo-maria.md)** — Zona de Antas evacuada el jueves; el Ayuntamiento pide esperar comunicación oficial para volver (19:29 del sábado). Coordenada del cerro homónimo (Nominatim).
- **[Camping Los Gallardos · retorno autorizado](marker-camping-los-gallardos.md)** — Camping junto a la salida 525 de la A-7, evacuado el jueves; regreso autorizado por Sanz la noche del sábado 11 (21:24).
...
- **[El Marchal (Lubrín) · evacuado, retorno pendiente](marker-el-marchal.md)** — Pedanía evacuada a contrarreloj el viernes por la tarde (~50 vecinos); la UME remató focos secundarios hacia su cementerio el sábado. Sin autorización de regreso.
...
- **[Hotel Playavera](marker-hotel-playavera.md)** — Hotel en Vera Playa, frente a la playa; opción de alojamiento durante la emergencia.
...
- **[Los Castaños · retorno autorizado](marker-los-castanos.md)** — Barriada del eje AL-5102 al sur de Lubrín, evacuada el viernes con prioridad; regreso autorizado por Sanz la noche del sábado 11 (21:24). Nominatim la sitúa en el término de Sorbas.
- **[Los Chopos (Antas) · evacuado, retorno pendiente](marker-los-chopos.md)** — Barriada de Antas evacuada el jueves; el Ayuntamiento pide esperar comunicación oficial para volver (19:29 del sábado).
- **[Los Gallardos](marker-los-gallardos.md)** — Municipio junto al que se originó el incendio (cable eléctrico, km 511 de la N-340A).
- **[Los Raimundos (Antas) · evacuado, retorno pendiente](marker-los-raimundos.md)** — Pedanía de Antas evacuada el jueves; el Ayuntamiento pide esperar comunicación oficial para volver (19:29 del sábado).
...
- **[Valle del Este · de vuelta en casa (~14:20)](marker-valle-del-este.md)** — Urbanización de origen del autor, fuera del perímetro y nunca evacuada oficialmente; regreso completado el domingo, todo en buen estado. *(personal)*
