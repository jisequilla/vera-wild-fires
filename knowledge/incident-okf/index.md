...
- **[events/](events/index.md)** (65) — Sucesos fechados, append-only: una corrección es otro evento enlazado (patrón "Matiz"), nunca una reescritura.
...
- **[state/](state/index.md)** (23) — Lo que ES ahora: métricas, zonas, carreteras y previsión meteo. Se supersede con `supersedes`, nunca se borra; la fluctuación histórica vive en el cuerpo de cada concepto.
<!-- okf:index:end -->
