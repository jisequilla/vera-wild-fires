...
- **[↗ Domingo · Flanco este estabilizado (oficial) · 25+ h sin focos · regreso propio a VdE decidido](situacion.md)** — Resumen de situación vigente para el autor — la Junta declara por escrito estabilizados el flanco este y la cabeza, el retorno del oeste está en marcha, la noche pasó sin detecciones y el autor ha decidido regresar hoy a Valle del Este. *(personal)*
...
- **[El Chive, La Alameda y cortijos de Bédar — evacuado](zona-el-chive.md)** — Desalojados en la reactivación nocturna del perímetro noroeste; ~60 personas en El Chive y 15 en La Alameda.
...
- **[Valle del Este — regreso decidido para hoy (decisión propia informada)](zona-valle-del-este.md)** — Fuera del perímetro, en el flanco este declarado estabilizado, nunca evacuada oficialmente; el autor regresa el domingo por decisión propia mientras las zonas del oeste vuelven con autorización. *(personal)*
- **[Vera Playa — posición actual, segura (partida hoy al mediodía)](zona-vera-playa.md)** — Posición actual del autor y su refugio desde el día 10; la partida de regreso a Valle del Este está prevista hoy hacia el mediodía. *(personal)*
<!-- okf:index:end -->
