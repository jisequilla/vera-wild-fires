# directory — contactos y fuentes oficiales

Teléfonos de emergencia, cuentas oficiales en X y páginas oficiales verificadas (lección EMSR671: nada entra sin abrirse y confirmarse).

<!-- okf:index:begin -->
- **[AEMET · avisos meteorológicos](aemet-avisos.md)** — Avisos oficiales por viento y temperatura — la ventana de riesgo sale de aquí.
- **[Apoyo psicológico a afectados](apoyo-psicologico.md)** — Línea de apoyo psicológico para afectados por el incendio.
- **[Ayuntamiento de Vera (Facebook)](ayto-vera-facebook.md)** — Canal del ayuntamiento del municipio del autor — la fuente que anunciaría novedades específicas de Vera y sus urbanizaciones (Valle del Este incluida).
...
- **[@Plan_INFOCA (X)](x-plan-infoca.md)** — Partes de medios y estado del fuego (EMA INFOCA).
- **[@UMEgob (X)](x-ume.md)** — Unidad Militar de Emergencias · dispositivo militar.
<!-- okf:index:end -->
